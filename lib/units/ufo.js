...
const { ufo2, EMPTYCHAR, UFOCHAR, ufo1, BUNKERCHAR, UFOBULLETCHAR, PLAYERCHAR, BULLETCHAR, bulletObj, BOARDHEIGHT } = require('./../constants');
const { playerGotHit } = require('./canon');
const { resetBullet } = require('./shoot');
