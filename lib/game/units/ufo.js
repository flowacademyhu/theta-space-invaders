...
const { play } = require('./../sound/sounds');
const { ufo2, UFOstep, EMPTYCHAR, UFOCHAR, ufo1, BUNKERCHAR, UFOBULLETCHAR, PLAYERCHAR, BULLETCHAR, bulletObj, BOARDHEIGHT, gameState } = require('./../constants');
