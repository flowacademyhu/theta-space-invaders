const { BOARDHEIGHT, EMPTYCHAR, BULLETCHAR, MOTHERSHIPCHAR, BUNKERCHAR, POINTS, PLAYER, UFOCHAR, UFOBULLETCHAR, ufo1, ufo2, bulletObj } = require('../constants');
...
const ufoGotHit = (matrix) => {
  player.play('./lib/game/sound/bullethit.mp3');
  matrix[bulletObj.row][bulletObj.position] = EMPTYCHAR;
};
