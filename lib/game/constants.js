...
const EMPTYCHAR = ' ';
const UFOPOS = { i: 2, j: 1, dir: 0, shot: 0, speed: 7 };
const BULLETCHAR = '•';
const BUNKERCHAR = 'B';
...
const gameState = { run: false, over: 'win' };
const UFOstep = './lib/game/sound/ufo.mp3';
const bulletHit = './lib/game/sound/bullethit.mp3';
const canonStep = './lib/game/sound/moving.mp3';
const canonShot = './lib/game/sound/shoot.mp3';
const playerDeath = './lib/game/sound/playerdeath.mp3';
const menuMusic = './lib/game/sound/menu.mp3';
const score = { stop: false };
const state = { s: false, c: 0 };
