const { BOARDHEIGHT, UFOBULLETCHAR, BULLETCHAR, BOARDWIDTH, EMPTYCHAR, PLAYERLIMIT, PLAYER, BUNKERCHAR, PLAYERCHAR, MOTHERSHIPCHAR, UFOCHAR } = require('../constants');
